...
public class StringEditDistanceFunctionTest {
    ...
    public void testCommutative() {
        ...
        assertEquals(df1.distance("longgggggg", "short"), df1.distance("short", "longgggggg"), 0);
        assertEquals(df1.distance("", "s1"), df1.distance("s1", ""), 0);
        // Test alphabetic mode
        assertEquals(df2.distance("1", "2"), df2.distance("2", "1"), 0);
        assertEquals(df2.distance("longgggggg", "short"), df2.distance("short", "longgggggg"), 0);
        assertEquals(df2.distance("", "s1"), df2.distance("s1", ""), 0);
        // Test keyboard mode
        assertEquals(df3.distance("1", "2"), df3.distance("2", "1"), 0);
        assertEquals(df3.distance("longgggggg", "short"), df3.distance("short", "longgggggg"), 0);
    ...
    public void testTriangle() {
        ...
        assertTrue("Distance must obey the triangle inequality", df3.distance("arbitrary", "other") + df3.distance("other", "sobering") >= df3.distance("arbitrary", "sobering"));
    }
