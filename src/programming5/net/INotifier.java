...
/**
 *Interface for event notifiers. A notifier signals its subscribers, but does not include an event parameter when it does so. 
 *There is an abstract implementation of this interface that handles the basic subscription and 
