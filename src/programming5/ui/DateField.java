 ...
 *the conventions of SimpleDateFormat must be specified for the object to work. There is also a swing counterpart.
 *@see JDateField
...
public class DateField extends TextField {
	...
	/**
         ...
         */
        public DateField(String dateFormat, boolean showPattern) {
		super();
		formatter = new SimpleDateFormat(dateFormat);
		if (showPattern) {
