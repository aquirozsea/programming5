...
public class NumberField extends TextField {
	...
	/**
         ...
         */
        public NumberField(double min_value, double max_value) {
	...
	/**
		...
		else throw new IllegalArgumentException("NumberField.setRange: Minimum must be less than or equal to the maximum");
	}
}
